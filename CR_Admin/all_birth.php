...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-dark dark-sidebar-color logo-dark dark-theme">
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Birth Certificates</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">All Birth Certificates</li>
							</ol>
						</div>
					</div>
					<div class="row">
										...
										<div class="row">
											<div class="col-md-12">
												<div class="card card-box">
													<div class="card-head">
														<header>All Birth Certificates</header>
														<div class="tools">
															...
															<div class="col-md-6 col-sm-6 col-6">
																<div class="btn-group pull-right">
																	...
																	<ul class="dropdown-menu pull-right">
																		<li>
																			<a href="javascript:;" onclick="printTab('shape')" >
  ...
  $sql = "SELECT * FROM BIRTH_CERTIFICATE WHERE RCenterID = '$sub' ";

  $result = mysqli_query($conn, $sql) or die('could not access database'. mysqli_error($conn));
   ?>

														<div class="table-scrollable" id="shape">
  ...
  while($row = mysqli_fetch_assoc($result)){
      //Putting certificate information in the table.
																	...
																	<tr class="odd gradeX">
																		...
																		<td class="left"><?php echo "{$row['CName']}"; ?></td>
																		<td class="left"><?php echo "{$row['CSex']}"; ?></td>
																		<td class="left"><?php echo "{$row['CDOB']}"; ?></td>
																		<td><?php echo "{$row['IDate']}"; ?></td>
																		<td class="left"><?php echo "{$row['DCenterID']}"; ?></td>
																				
																		
																		<td>

																			<form method ="post" action="edit_birth.php">
          ...
          <button class="button btn-primary btn-xs" type="submit" name ="edit"><i class="fa fa-pencil"></i></button>
																			...
																			<button class="btn btn-danger btn-xs" type="submit" name="deletebc">
																				<i class="fa fa-trash-o "></i>
																			</button>
																			</form>

																			<form method="post" action="bc_view.php">
		                                                                     <input type="hidden" name="bcnum" value="<?php echo "{$row['BCNumber']}"; ?>">	
